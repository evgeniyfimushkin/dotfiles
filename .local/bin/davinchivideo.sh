...
# execute as: davincivideo.sh 'file name.mp4'
...
# Updated 21 March 2025 as output file definition was missing.
...
# Get the output file name (same name as input but with .mov extension)
